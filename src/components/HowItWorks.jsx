...
const HowItWorks = () => {
    return (
        <section className='bg-[#F7F7F7] p-5 my-5'>
            ...
            <div className="bg-gradient-to-b from-blue-50 to-green-50 py-12 grid grid-cols-1 md:grid-cols-2 gap-8 p-5 lg:grid-cols-3">
                {/* First Card */}
                ...
                {/* Third Card (Centered on Medium Devices) */}
                <div className="card bg-white shadow-lg shadow-blue-100 rounded-lg p-6 md:col-span-2 md:col-start-1 lg:col-span-1 lg:col-start-auto flex md:justify-center">
                    <div>
                        <figure className="px-4 pt-4">

        ...
        <div className="min-h-screen flex">
            ...
            <div className="w-full lg:w-2/5 flex items-center justify-center bg-base-100">
                <div className="max-w-md w-full p-8 shadow-2xl">
                    ...
                    <p className="text-center font-poppins my-2"><small>Already have an Account? <Link to='/login'><span className="text-blue-600">Please login</span></Link></small></p>
                </div>
            </div>
             {/* Banner Section - 60% width */}
             <div className="w-3/5 bg-cover bg-center hidden lg:block" style={{ backgroundImage: `url(${banner})` }}>
